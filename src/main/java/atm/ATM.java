...
public class ATM {
	 ...
	 */
	@Autowired //ใส่ในclassที่ @Componantที่mwthodที่มีdependency rejectionคือใช้เมื่อมีcompositionเท่านั้น ซึ่งอันนี้จะส่งBankให้ATMอัตโนมัติ->ทำcompositionให้อัตโนมัติ
